...
<ul class="nav flex-column">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam05/ContentController">요청정보 얻기</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Exam06.</span>
			<a class="text-white" href="/servletjsp/exam06/ContentController">상태유지 - Cookie(클라이언트 저장)</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam10/ContentController">예외처리(try-catch)</a>
		</h6>
	</li>
</ul>